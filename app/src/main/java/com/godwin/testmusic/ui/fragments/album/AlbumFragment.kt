...
import com.godwin.testmusic.databinding.FragmentAlbumBinding
...
class AlbumFragment : Fragment(), OnItemClickListener<Song> {

    private lateinit var binding: FragmentAlbumBinding
    private val mainViewModel by activityViewModels<MainActivityViewModel>()
    private val viewModel by viewModels<AlbumViewModel>()

    private val adapter = SongAdapter(SongAdapter.ViewType.ALBUM,this)
    ...
    override fun onClick(t: Song?) {
        t?.let {
            ...
            findNavController().navigate(R.id.actionAlbumToDetails)
        }
    }
}